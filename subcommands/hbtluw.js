...
row1.addComponents(zwaar_bs,axe_bs,knots_bs)
...
if(player_info_gold < 2) return m.reply({embeds: [niet_genoeg_goud]})
...
.setDescription('Je hebt niet genoeg goud!')
const player_info_gold = await db.get(`player_${message.author.id}.gold`)
if(player_info_gold < 3) return m.reply({embeds: [niet_genoeg_goud]})
        
        const zwaard_bought = new Discord.MessageEmbed()
        .setImage('https://cdn.discordapp.com/attachments/938896295366651944/939248445066207292/knots_dinge.png')
        .setColor(0x5865F2)
